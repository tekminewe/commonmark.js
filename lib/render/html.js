...
function at_mention(node, entering) {
  if (entering) {
      ...
      if (node.mentionName) {
          attrs.push(['data-mention-name', esc(node.mentionName, true)]);
      }
...
function channel_link(node, entering) {
  if (entering) {
      ...
      if (node.channelName) {
          attrs.push(['data-channel-name', esc(node.channelName, true)]);
      }
...
function emoji(node, entering) {
  if (entering) {
      ...
      if (node.emojiName) {
          attrs.push(['data-emoji-name', esc(node.emojiName, true)]);
          attrs.push(['data-literal', esc(node.literal, true)]);
      }
